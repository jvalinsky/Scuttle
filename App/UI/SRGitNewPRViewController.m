...
- (void)loadView {
    self.view = [[NSView alloc] initWithFrame:NSMakeRect(0, 0, 450, 400)];
}
...
- (void)setupUI {
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [baseLabel.topAnchor constraintEqualToAnchor:self.titleField.bottomAnchor constant:12],
        ...
        [headLabel.topAnchor constraintEqualToAnchor:self.titleField.bottomAnchor constant:12],
        ...
        [bodyLabel.topAnchor constraintEqualToAnchor:self.baseBranchField.bottomAnchor constant:12],
...
- (void)submit:(id)sender {
    ...
    NSDictionary *content = @{
        ...
        @"baseBranch": base,
        @"headRepo": self.repoID, // Same-repo PR for now
        @"headBranch": head,
        @"title": title,
        @"text": body
    };
